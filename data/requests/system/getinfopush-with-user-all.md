...
* Invalid type at ``#/25/data/description``,
...
* Unexpected property at ``#/27data/disclaimerText``,
* Unexpected property at ``#/27data/domainList``,
* Unexpected property at ``#/27data/worldTag``,
...
* Unexpected property at ``#/29data/categories``,
* Unexpected property at ``#/29data/featuredAvatarCategoryId``,
* Unexpected property at ``#/29data/iconImageUrl``,
* Unexpected property at ``#/29data/tooltipDescription``,
* Cannot fit value in explicit enum at ``#/30/data/onPressed/command``,
