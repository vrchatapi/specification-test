...
* Unexpected property at ``#/26data/disclaimerText``,
* Unexpected property at ``#/26data/domainList``,
* Unexpected property at ``#/26data/worldTag``,
...
* Unexpected property at ``#/28data/categories``,
* Unexpected property at ``#/28data/featuredAvatarCategoryId``,
* Unexpected property at ``#/28data/iconImageUrl``,
* Unexpected property at ``#/28data/tooltipDescription``,
