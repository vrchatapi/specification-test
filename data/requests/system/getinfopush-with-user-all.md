...
* Unexpected property at ``#/85data/categories``,
* Unexpected property at ``#/85data/featuredAvatarCategoryId``,
* Unexpected property at ``#/85data/iconImageUrl``,
* Unexpected property at ``#/85data/tooltipDescription``,
...
* Invalid type at ``#/153/data/description``,
...
* Unexpected property at ``#/172data/disclaimerText``,
* Unexpected property at ``#/172data/domainList``,
* Unexpected property at ``#/172data/worldTag``,
