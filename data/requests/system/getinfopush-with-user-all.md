...
* Unexpected property at ``#/280data/tooltipDescription``,
...
* Invalid type at ``#/286/data/description``,
* Unexpected property at ``#/286data/iconImageUrl``,
* Unexpected property at ``#/286data/tooltipDescription``,
...
* undefined at ``#/326/data/imageUrl``,
* Invalid type at ``#/326/startDate``,
* Unexpected property at ``#/326/regions``,
* Unexpected property at ``#/326/requireClientTags``,
* Unexpected property at ``#/327data/contentList/bannersTag``,
* Unexpected property at ``#/327data/contentList/shortName``,
* Unexpected property at ``#/327data/iconImageUrl``,
* Unexpected property at ``#/327data/shortName``,
...
| x-vrc-request-id | `m33qvgdqvlvs8f7n` |
