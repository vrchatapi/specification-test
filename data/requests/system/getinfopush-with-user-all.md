...
* Invalid type at ``#/270/data/description``,
* Unexpected property at ``#/270data/iconImageUrl``,
* Unexpected property at ``#/270data/tooltipDescription``,
...
* Unexpected property at ``#/275data/tooltipDescription``,
...
| x-vrc-request-id | `m32bjbu18hd35nk6` |
