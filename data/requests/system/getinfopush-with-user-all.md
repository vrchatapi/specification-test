...
* Unexpected property at ``#/4data/contentList/avatarSpecific``,
* Unexpected property at ``#/4data/contentList/bannersTag``,
* Unexpected property at ``#/4data/contentList/shortName``,
* Unexpected property at ``#/4data/iconImageUrl``,
* Unexpected property at ``#/4data/shortName``,
* Unexpected property at ``#/4data/thumbnailImageUrl``,
* Unexpected property at ``#/4data/tooltipDescription``,
