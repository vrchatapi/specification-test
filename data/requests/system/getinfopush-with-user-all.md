...
* Unexpected property at ``#/142data/categories``,
...
* Invalid type at ``#/213/data/description``,
...
* Unexpected property at ``#/271data/disclaimerText``,
* Unexpected property at ``#/271data/domainList``,
* Unexpected property at ``#/271data/worldTag``,
...
* Cannot fit value in explicit enum at ``#/280/data/onPressed/command``,
