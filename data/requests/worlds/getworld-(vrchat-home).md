...
```jsonc
{
  ...
  "slimInstances": [
    ...
    {
      "gameServerVersion": 1626,
      "instanceId": "85321~group(grp_bf4af21f-6d62-44d0-8a04-afd5ff6801ec)~groupAccessType(public)~region(us)",
      "languageRatio": {
        "en": 0.79,
        "es": 0.05,
        "fr": 0.11,
    ...
    {
      "gameServerVersion": 1626,
      "instanceId": "e1f22ec989~region(us)",
      "languageRatio": {
        "en": 1
      },
      "n_users": 3
